...
本の情報とカバー画像を登録し、ページネーション付きの一覧で管理できます。

![本の登録・一覧画面](docs/images/book-index.png)

### 本の検索

タイトル・著者名・出版年による検索と、表示順の並べ替えに対応しています。

![本の検索画面](docs/images/book-search.png)

### 本の詳細

登録した本のタイトル、著者、出版年、カバー画像を確認できます。

![本の詳細画面](docs/images/book-preview.png)

### 本の編集

本の情報、著者、カバー画像を編集できます。

![本の編集画面](docs/images/book-edit.png)

### 著者の削除確認

誤操作を防ぐため、著者を削除する前に確認モーダルを表示します。

![著者の削除確認画面](docs/images/author-delete.png)
